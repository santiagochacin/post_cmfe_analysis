...
## JJM modified to add Batch_Process_select_reference function 
...
def Batch_Process_select_reference(video_dict,tracking_params,reference_image,bin_dict,region_names,stretch,crop,poly_stream=None):
